...
$sql = "SELECT * FROM sys_workflow_divisional_access ORDER BY ID DESC";
  ...
  <div class="col-lg-12">
    <div class="card shadow-8">
      <div class="card-header text-white bg-success">
        <div class="row">
          <div class="col-11">
            <b><i class="fas fa-caret-right"></i> Div. Secretary Main Setup</b>
          </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <b><i class="fas fa-user-tie"></i> New Secretary</b>
              <button type="button" class="btn-close" data-mdb-ripple-init data-mdb-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col-12">
                  <select id="secretary" class="sec-select" data-mdb-select-init data-mdb-container="#setup" data-mdb-filter="true">
                  ...
                  <label class="form-label select-label text-primary">
                    <b>Divisional Secretary</b>
                  </label>
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <button id="add_secretary" class="btn btn-primary">
            ...
            <table class="table table-sm table-hover table-striped" style="white-space: nowrap;">
              ...
              <tbody class="text-left table-group-divider table-divider-primary-color">
                ...
                <tr>
                  ...
                  <td>
                    <select class="search_secretary sec-select" data-mdb-size="sm" data-mdb-select-init data-mdb-filter="true">
                      <option value="" data-id="<?php echo $value['CDIVISION']; ?>">- Select -</option>
                      <?php foreach ($result2 as $value2) { ?>
                      <option value="<?php echo $value2['CJOB']; ?>" data-id="<?php echo $value['CDIVISION']; ?>" data-ce="<?php echo $value2['CNOEE']; ?>" <?= ($value2['CNOEE'] == $value['CNOEE']) ? "selected" : "" ?>>
  ...
  <div class="col-lg-12">
    <div class="card shadow-8">
      <div class="card-header text-white bg-primary">
        <div class="row">
          <div class="col-11">
            <b><i class="fas fa-caret-right"></i> Div. Secretary Backup Setup</b>
          </div>
        </div>
      </div>
      <div class="card-body">
            ...
            <table class="table table-sm table-hover table-striped" style="white-space: nowrap;">
              ...
              <tbody class="text-left table-group-divider table-divider-primary-color">
                ...
                <tr>
                  ...
                  <td><?php echo $divname; ?></td>
                  <td>
                    <select class="search_backup sec-select" data-mdb-size="sm" data-mdb-select-init data-mdb-filter="true">
                      <option value="" data-id="<?php echo $value['CDIVISION']; ?>">- Select -</option>
                      <?php foreach ($result2 as $value2) { ?>
                      <option value="<?php echo $value2['CJOB']; ?>" data-id="<?php echo $value['CDIVISION']; ?>" data-ce="<?php echo $value2['CNOEE']; ?>" <?= ($value2['CNOEE'] == $value['SNOEE']) ? "selected" : "" ?>>
                        <?php echo $value2['CNAME']; ?>
                      </option>
                      <?php } ?>
                    </select>
...
$(document).ready(function() {
  $(".search_secretary").change(function(){
    var jb = $(this).val();
    var dv = $(this).find(':selected').attr('data-id');
    var ce = $(this).find(':selected').attr('data-ce');
    $.ajax({
      url:'modules/system/api_main',
      type:'POST',
      data:{edit_secretary:dv,jb:jb,ce:ce},
      beforeSend: function() {    
        Swal.fire({
          title: 'SAVING',
          allowEscapeKey: false,
...
$(document).ready(function() {
  $(".search_backup").change(function(){
    ...
    $.ajax({
      url:'modules/system/api_main',
      type:'POST',
      data:{edit_secretary_backup:dv,jb:jb,ce:ce},
      beforeSend: function() {    
        Swal.fire({
          title: 'SAVING',
          allowEscapeKey: false,
