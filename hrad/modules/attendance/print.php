...
$sql = "SELECT * FROM employees_demas WHERE CNAME LIKE '%$name%' AND DRESIGN = '0000-00-00'";
...
$sql1 = "SELECT * FROM attendance WHERE name LIKE '%$name%'";
$result1 = $conn->query($sql1);
...
$totalH3 = floor($totalM1[$key]  / 60) + floor($totalM2[$key] / 60);
$totalMin3 = ($totalM1[$key] % 60) + ($totalM2[$key] % 60);
