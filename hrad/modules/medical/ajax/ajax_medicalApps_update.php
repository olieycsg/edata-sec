        ...
        <div class="row">
          <div class="col-4">
            <div class="form-outline" data-mdb-input-init>
              <input type="text" id="refid" class="form-control active not-allowed" value="<?php echo $row1['CMCCHIT']; ?>" disabled>
          ...
          <div class="col-4" style="margin-top: 15px;">
            <div class="form-outline" data-mdb-input-init>
              <input type="text" class="form-control active not-allowed" value="<?php echo strtoupper(date("d F Y", strtotime($row1['DCHIT']))); ?>" disabled>
              <label class="form-label text-primary active">
                <b>Date</b>
              </label>
            </div>
