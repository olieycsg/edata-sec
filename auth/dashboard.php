      ...
      <div class="col-lg-12">
        <div class="card shadow-8">
          <div class="card-header">
            <div class="row">
              <div class="col-11">
                <b><i class="fas fa-caret-right"></i> Admin Access</b>
              </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <b><i class="fas fa-user-tie"></i> New Access</b>
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-8" style="margin-bottom: 20px;">
                      <div class="form-outline" data-mdb-input-init data-mdb-container="#setup">
                        <input type="text" id="email" class="form-control active" placeholder="e.g olivianus@sabahenergycorp.com">
                        <label class="form-label select-label text-primary">
                          <b>Email</b>
                        </label>
                      </div>
...
$(document).ready(function(){
  $("#add").click(function(){
    ...
    $.ajax({
      url: "api_main",
      type:'POST',
      data:{add_access:sid,eml:eml,sts:sts},
      beforeSend: function() {    
        Swal.fire({
          title: 'SAVING',
          allowEscapeKey: false,
