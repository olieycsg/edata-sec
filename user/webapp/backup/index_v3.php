...
if($row = $result->fetch_assoc()){
  ...
  if($resulta->num_rows > 0) {
    ...
    if($rowa = $resulta->fetch_assoc()){
      $sql2 = "SELECT COUNT(eleave.ID) AS id FROM employees_demas LEFT JOIN eleave ON employees_demas.CNOEE = eleave.CNOEE AND eleave.MNOTES = 'recommended' WHERE employees_demas.DRESIGN = '0000-00-00' AND employees_demas.CDIVISION = '".$rowa['CDIVISION']."'";
      ...
      <main class="main" style="margin-bottom: 150px; padding: 30px;">
        <div class="row">
          ...
          <div class="col-12" style="margin-top: 15px;">
            <a href="recommend" class="card load text-dark">
              <div class="card-body text-center <?php echo ($cnt > 0) ? 'text-danger' : 'text-success'; ?>">
                ...
                <b style="font-size: 15px;">
                  ...
                  <?php echo ($chead == 0) ? 'Leave Recommendation' : 'Leave Approval'; ?> 
                </b>
              </div>
            </a>
          </div>
          ...
          <div class="col-12" style="margin-top: 15px;">
            <a href="index_v3?emid=<?php echo $_SESSION['emid']; ?>" class="card">
              <div class="card-body text-center text-primary">
                <h3 class="card-title"><i class="fas fa-bell"></i></h3>
                <b style="font-size: 15px;">New</b>
              </div>
            </a>
          </div>
          <?php } ?>
